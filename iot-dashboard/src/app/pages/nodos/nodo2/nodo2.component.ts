...
@Component({
  selector: 'ngx-nodo2',
  templateUrl: './nodo2.component.html',
  styleUrls: ['./nodo2.component.scss']

})

export class Nodo2Component implements OnInit, OnDestroy {
  private alive = true;
  private nodoId = '0x6002';
  ...
  onValueChange(value){
    this.gradosServo = Math.round(value);
    console.log(this.gradosServo);
    this.dbService.updateActuador(this.nodoId, this.actuadorId2,this.gradosServo);
  }
